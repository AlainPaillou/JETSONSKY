...
titre = "JetsonTreatment Jetson version V8.00 - CUDA / OPENCV - Copyright Alain PAILLOU 2018-2022"
flag_HQ = 0 
exp_min=100 #µs
exp_max=10000 #µs
exp_delta=100 #µs
...
Button (fenetre_principale, text = "Quitter", command = quitter,padx=10,pady=5).place(x=1760,y=990, anchor="e")
