...
# Titre programme
titre = "JetsonSky V14.16 Jetson Linux release - CUDA / OPENCV - Copyright Alain PAILLOU 2018-2022"
    ...
    if flag_image_disponible == True :
        if flag_stop_acquisition == False :
            ...
            if flag_TRKSAT == 1 and flag_noir_blanc == 0 and flag_colour_camera == True :
                satellites_tracking()
            if flag_FDIF == 1and flag_noir_blanc == 0 and flag_colour_camera == True :
                stars_detection()
