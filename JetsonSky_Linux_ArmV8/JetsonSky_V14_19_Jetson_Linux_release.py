...
# Titre programme
titre = "JetsonSky V14.19 Jetson Linux release - CUDA / OPENCV - Copyright Alain PAILLOU 2018-2022"
...
long int width, long int height, int flag_dyn_AADP, int flag_ghost_reducer)
{
...
mod = SourceModule("""
__global__ void adaptative_absorber_denoise_Mono(unsigned char *dest_r, unsigned char *img_r, unsigned char *old_r, long int width, long int height, int flag_dyn_AADP, int flag_ghost_reducer)
{
...
RBAADP1.place(anchor="w",x=1570, y=485)
RBAADP2 = Radiobutton(cadre,text="Low", variable=choix_dyn_AADP,command=choix_dyn_low,value=2)
RBAADP2.place(anchor="w",x=1615, y=485)
# AADF ghost reducer
CBGR = Checkbutton(cadre,text="Ghost Reducer", variable=choix_ghost_reducer,command=commande_ghost_reducer,onvalue = 1, offvalue = 0)
CBGR.place(anchor="w",x=1660, y=485)
