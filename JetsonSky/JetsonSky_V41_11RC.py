...
long int width, long int height, float val_sat, int flag_neg_sat)
{
    ...
    if (i < height && j < width) {
        ...
        dest_r[index] = (int)((r+m)*255);
        dest_g[index] = (int)((g+m)*255);
        dest_b[index] = (int)((b+m)*255);   
    }
}
''', 'Saturation_Colour_C')
...
def application_filtrage(res_b1,res_g1,res_r1) :
    global compteur_FS,Im1OK,Im2OK,Im3OK,compteur_images,numero_image,b1_sm, b2_sm, b3_sm, b4_sm, b5_sm, g1_sm, g2_sm, g3_sm, g4_sm, g5_sm, r1_sm, r2_sm, r3_sm, r4_sm, r5_sm,\
           ...
           imgb1,imgg1,imgr1,imgb2,imgg2,imgr2,imgb3,imgg3,imgr3,compteur_3FNR,img1_3FNROK,img2_3FNROK,img3_3FNROK,FNR_First_Start,flag_3FNR
        ...
        if flag_filtrage_ON == True :
            ...
            if flag_noir_blanc == 0 and flag_colour_camera == True:
                ...
                if (flag_histogram_stretch == 1 or flag_histogram_equalize2 == 1 or flag_histogram_phitheta == 1) or\
                   (flag_AmpSoft == 1  and (flag_lin_gauss == 1 or flag_lin_gauss == 2)) or val_reds != 100 or val_greens != 100 or val_blues != 100 :
...
CB3FNR = Checkbutton(cadre,text="Dn 3FNR", variable=choix_3FNR,command=commande_3FNR,onvalue = 1, offvalue = 0)
CB3FNR.place(anchor="w",x=1520+delta_s, y=505)
