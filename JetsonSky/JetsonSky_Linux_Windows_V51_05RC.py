...
def init_camera() :
    global camera,flag_colour_camera,format_capture,controls,res_cam_x,res_cam_y, \
           ...
           RES_X_BIN2_1_1,RES_Y_BIN2_1_1,sensor_bits_depth,type_debayer,Camera_Bayer,GPU_BAYER,bayer_sensor
...
class acquisition(Thread) :
    ...
    def run(self) :
        global type_debayer,camera,nb_erreur,image_brute,flag_autorise_acquisition,image_camera,key_pressed,\
