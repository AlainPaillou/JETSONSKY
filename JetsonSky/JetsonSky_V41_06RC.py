...
def refresh() :
    global video,flag_cap_video,camera,traitement,cadre_image,image_brute,flag_image_disponible,flag_quitter,timeoutexp,flag_new_image,curFPS,fpsQueue,image_brut_read,\
           ...
           calque_stars,calque_satellites,calque_TIP,flag_nouvelle_resolution,nb_sat,sat_x,sat_y,sat_s,res_bb1,res_gg1,res_rr1,image_camera_old,s1,flag_TRIGGER,\
...
def commande_reduce_variation() :
    global flag_reduce_variation,val_FSDN,compteur_FSDN,Im1fsdnOK,Im2fsdnOK
...
CBEPF.place(anchor="w",x=1450+delta_s, y=505)
...
echelle130.place(anchor="w", x=1720+delta_s,y=498)

# Choix filtre Reduce variations
CBRV = Checkbutton(cadre,text="Turbulence Filter", variable=choix_reduce_variation,command=commande_reduce_variation,onvalue = 1, offvalue = 0)
CBRV.place(anchor="w",x=1450+delta_s, y=535)
...
echelle270.place(anchor="w", x=1550+delta_s,y=535)
...
CBEPF.place(anchor="w",x=1450+delta_s, y=573)
...
echelle30.place(anchor="w", x=1510+delta_s,y=573)
...
CBDS.place(anchor="w",x=1645+delta_s, y=573)
...
echelle4.place(anchor="w", x=1710+delta_s,y=573)
...
CBGR.place(anchor="w",x=1450+delta_s, y=610)
...
echelle60.place(anchor="w", x=1600+delta_s,y=610)

# Choix Parametre Atenuation Gradient Removal
labelParam61 = Label (cadre, text = "At")
labelParam61.place(anchor="e", x=1735+delta_s,y=610)
...
echelle61.place(anchor="w", x=1740+delta_s,y=610)
...
CBIN.place(anchor="w",x=1450+delta_s, y=650)
...
CBHE2.place(anchor="w",x=1520+delta_s, y=650)
...
echelle16.place(anchor="w", x=1580+delta_s,y=650)
...
CBHS.place(anchor="w",x=1450+delta_s, y=690)

labelParam5 = Label (cadre, text = "Min") # choix valeur histogramme strech minimum
labelParam5.place(anchor="w", x=1555+delta_s,y=690)
...
echelle5.place(anchor="w", x=1580+delta_s,y=690)

labelParam6 = Label (cadre, text = "Max") # choix valeur histogramme strech maximum
labelParam6.place(anchor="w", x=1700+delta_s,y=690)
...
echelle6.place(anchor="w", x=1720+delta_s,y=690)
...
CBHPT.place(anchor="w",x=1450+delta_s, y=730)

labelParam12 = Label (cadre, text = "Pnt") # choix valeur histogramme Signoide param 1
labelParam12.place(anchor="w", x=1555+delta_s,y=730)
...
echelle12.place(anchor="w", x=1580+delta_s,y=730)

labelParam13 = Label (cadre, text = "Dec") # choix valeur histogramme Signoide param 2
labelParam13.place(anchor="w", x=1700+delta_s,y=730)
...
echelle13.place(anchor="w", x=1720+delta_s,y=730)
...
CBCC.place(anchor="w",x=1450+delta_s, y=770)

labelParam9 = Label (cadre, text = "Clip") # choix valeur contrate CLAHE
labelParam9.place(anchor="w", x=1555+delta_s,y=770)
...
echelle9.place(anchor="w", x=1580+delta_s,y=770)
labelParam109 = Label (cadre, text = "Grid") # choix valeur contrate CLAHE
labelParam109.place(anchor="w", x=1700+delta_s,y=770)
...
echelle109.place(anchor="w", x=1720+delta_s,y=770)
...
CBCPT.place(anchor="w",x=1450+delta_s, y=805)

labelParam99 = Label (cadre, text = "Value") # choix valeur contrate CLAHE
labelParam99.place(anchor="w", x=1555+delta_s,y=805)
...
echelle99.place(anchor="w", x=1580+delta_s,y=805)
