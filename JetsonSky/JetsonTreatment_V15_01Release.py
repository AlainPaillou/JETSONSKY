...
Video_Test ='C:\Soft\JetsonSky\Videos\Your_Video.avi'




Treatment_version = "V15.01"
...
if my_os == "win32" :
    ...
    titre = "JetsonTreatment " +  Treatment_version + " Windows release - CUDA / OPENCV - Copyright Alain PAILLOU 2018-2022"

if my_os == "linux" :
    Dev_system = "Jetson Linux"
    print("Linux system")
    titre = "JetsonTreatment " +  Treatment_version + " Linux release - CUDA / OPENCV - Copyright Alain PAILLOU 2018-2022" 
...
def refresh() :
    global camera,traitement, img_cam,cadre_image,rawCapture,image_affichee,image_brut,flag_image_disponible,flag_quitter,\
           ...
           val_gain, echelle2,val_exposition,echelle1,imggrey1,imggrey2,flag_FDIF,FDIF,flag_TRKSAT,correspondance,res_bb1,res_gg1,res_rr1,image_brute,\
           ...
           flag_cap_video,nb_cap_video,video
    ...
    if (video.isOpened()):
        ...
        if ret == True :
            ...
            image_brute=cv2.cvtColor(image_brut_Base, cv2.COLOR_BGR2RGB)
            ...
            if flag_nouvelle_resolution == True :
                ...
                calque_met = np.zeros_like(image_brute)
