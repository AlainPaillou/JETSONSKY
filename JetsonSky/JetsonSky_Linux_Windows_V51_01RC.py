                ...
                if flag_HDR == True and flag_filtrage_ON == True :
                    try :
                        if flag_16b == False :
                            ...
                            thres1 = 2 ** (16 - delta_th * 0)
                            thres2 = 2 ** (16 - delta_th * 1)
                            thres3 = 2 ** (16 - delta_th * 2)
                            thres4 = 2 ** (16 - delta_th * 3)
                ...
                if flag_SER_file == False :
                    ...
                    if SER_depth == 16 :
                        if flag_HDR == True and flag_filtrage_ON == True : 
                            ...
                            image_camera_tmp = cp.asarray(image_brute,dtype=cp.uint16)
                            image_camera_base = image_camera_tmp.get()
