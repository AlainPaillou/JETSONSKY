...
compteur_3FNR  = 0
GPU_BAYER = 1 #  0 : RAW   1 : RGGB   2 : BGGR    3 : GBRG     4 : GRBG
...
bayer_sensor = IntVar()
bayer_sensor.set(2) # Position filter wheel
...
unsigned char *img, long int width, long int height, int GPU_BAYER)
{
  ...
  if (i < (height-2) && i > 1 && j < (width-2) && j >2) {
      if (GPU_BAYER == 1) {
          dest_r[i1]=img[i1];  
    ...
    if (i < 2 || j < 2 || ( i > (height - 3) && i < height) || (j > (width -3) && j < width)) {
      if (GPU_BAYER == 1) {
          dest_r[i1]=img[i1];  
          dest_g[i1]=img[i2];
          dest_b[i1]=img[i4];
...
def commande_flipV() :
    global FlipV,FlipH,type_flip,choix_flipV
...
def commande_flipH() :
    global FlipV,FlipH,type_flip,choix_flipH
...
def choix_bayer_RAW(event=None) :
    global video_debayer,GPU_BAYER
    video_debayer = 0 # RAW
    GPU_BAYER = 0
...
labelParam50.place(anchor="w", x=15,y=190)
...
echelle50.place(anchor="c", x=20,y=255)
...
labelFW.place (anchor="w",x=5, y=405+140)
RBEFW1 = Radiobutton(cadre,text="RAW", variable=bayer_sensor,command=choix_bayer_RAW,value=1)
RBEFW1.place(anchor="w",x=5, y=430+140)
RBEFW2 = Radiobutton(cadre,text="RGGB", variable=bayer_sensor,command=choix_bayer_RGGB,value=2)
RBEFW2.place(anchor="w",x=5, y=450+140)
RBEFW3 = Radiobutton(cadre,text="BGGR", variable=bayer_sensor,command=choix_bayer_BGGR,value=3)
RBEFW3.place(anchor="w",x=5, y=470+140)
RBEFW4 = Radiobutton(cadre,text="GBRG", variable=bayer_sensor,command=choix_bayer_GBRG,value=4)
RBEFW4.place(anchor="w",x=5, y=490+140)
RBEFW5 = Radiobutton(cadre,text="GRBG", variable=bayer_sensor,command=choix_bayer_GRBG,value=5)
RBEFW5.place(anchor="w",x=5, y=510+140)

labelTRK = Label (cadre, text = "Tracking")
labelTRK.place (anchor="w",x=0, y=550+140)

# Find Stars
CBDTCSTARS = Checkbutton(cadre,text="Stars", variable=choix_DETECT_STARS,command=commande_DETECT_STARS,onvalue = 1, offvalue = 0)
CBDTCSTARS.place(anchor="w",x=0, y=570+140)

# Track Satellites
CBTRKSAT = Checkbutton(cadre,text="Sat Detect", variable=choix_TRKSAT,command=commande_TRKSAT,onvalue = 1, offvalue = 0)
CBTRKSAT.place(anchor="w",x=0, y=590+140)

# Remove Satellites
CBREMSAT = Checkbutton(cadre,text="Sat Remov", variable=choix_REMSAT,command=commande_REMSAT,onvalue = 1, offvalue = 0)
CBREMSAT.place(anchor="w",x=0, y=610+140)

# Track Meteor
CBTRIGGER = Checkbutton(cadre,text="Trigger", variable=choix_TRIGGER,command=commande_TRIGGER,onvalue = 1, offvalue = 0)
CBTRIGGER.place(anchor="w",x=0, y=630+140)

# RAZ Tracking traces
Button7 = Button (cadre,text = "RAZ Trk", command = raz_tracking,padx=10,pady=0)
Button7.place(anchor="w", x=0,y=655+140)

# Track Meteor
CBCONST = Checkbutton(cadre,text="Reconst", variable=choix_CONST,command=commande_CONST,onvalue = 1, offvalue = 0)
CBCONST.place(anchor="w",x=0, y=675+140)
...
echelle100 = Scale (cadre, from_ = 70, to = 130, command= choix_w_reds, orient=HORIZONTAL, length = 160, width = 7, resolution = 0.5, label="",showvalue=1,tickinterval=10,sliderlength=20)
...
echelle101 = Scale (cadre, from_ = 70, to = 130, command= choix_w_greens, orient=HORIZONTAL, length = 160, width = 7, resolution = 0.5, label="",showvalue=1,tickinterval=10,sliderlength=20)
...
echelle102 = Scale (cadre, from_ = 70, to = 130, command= choix_w_blues, orient=HORIZONTAL, length = 160, width = 7, resolution = 0.5, label="",showvalue=1,tickinterval=10,sliderlength=20)
...
echelle152 = Scale (cadre, from_ = 0, to = 6, command= choix_val_sharpen, orient=HORIZONTAL, length = 120, width = 7, resolution = 0.1, label="",showvalue=1,tickinterval=1,sliderlength=20)
echelle152.set(val_sharpen)
echelle152.place(anchor="w", x=1560+delta_s,y=420)
echelle153 = Scale (cadre, from_ = 1, to = 11, command= choix_val_sigma_sharpen, orient=HORIZONTAL, length = 120, width = 7, resolution = 2, label="",showvalue=1,tickinterval=2,sliderlength=20)
...
echelle154 = Scale (cadre, from_ = 0, to = 6, command= choix_val_sharpen2, orient=HORIZONTAL, length = 120, width = 7, resolution = 0.1, label="",showvalue=1,tickinterval=1,sliderlength=20)
echelle154.set(val_sharpen2)
echelle154.place(anchor="w", x=1560+delta_s,y=450)
echelle155 = Scale (cadre, from_ = 1, to = 11, command= choix_val_sigma_sharpen2, orient=HORIZONTAL, length = 120, width = 7, resolution = 2, label="",showvalue=1,tickinterval=2,sliderlength=20)
