...
class acquisition(Thread) :
    ...
    def run(self) :
        global type_debayer,camera,nb_erreur,image_brute,flag_acquisition_en_cours,flag_autorise_acquisition,Date_hour_image,\
               ...
               flag_sub_dark,choix_BGSUB,flag_BG_OK,flag_sub_BG,image_BG,compteur_images,numero_image
...
def refresh() :
    global camera,traitement, img_cam,cadre_image,rawCapture,image_affichee,image_brut,flag_image_disponible,flag_quitter,\
           ...
           calque_direction_satellites,correspondance,vitesse,sat_id,sat_old_id,compteur_sat,old_sat,sat_speed,compteur_images,numero_image
...
def application_filtrage() :
    ...
    if flag_TIP == True :
        ...
        texte_TIP = Date_hour_image + "  Frame nbr : " + str(numero_image) + "  Dropped frames : " + str(compteur_images - numero_image)
        font = cv2.FONT_HERSHEY_SIMPLEX
