...
class acquisition(Thread) :
    ...
    def run(self) :
        global type_debayer,camera,nb_erreur,image_brute_base,flag_acquisition_en_cours,flag_autorise_acquisition,image_camera,\
               ...
               res_bb1,res_gg1,res_rr1,flag_sub_dark,numero_image,timeoutexp,flag_new_image,image_brute_grey
...
def application_filtrage(res_b1,res_g1,res_r1) :
    global compteur_FS,Im1OK,Im2OK,Im3OK,compteur_images,numero_image,b1_sm, b2_sm, b3_sm, b4_sm, b5_sm, g1_sm, g2_sm, g3_sm, g4_sm, g5_sm, r1_sm, r2_sm, r3_sm, r4_sm, r5_sm,\
           Im4OK,Im5OK,flag_hold_picture,val_denoise,val_denoise_KNN,val_histo_min,val_histo_max,image_camera,image_camera_old,image_brute_grey, \
...
#                Colour_2_Grey_GPU((nb_blocksX,nb_blocksY),(nb_ThreadsX,nb_ThreadsY),(r_gpu, res_b1, res_g1, res_r1, np.int_(width), np.int_(height)))

#                imagegrey = r_gpu.copy()              

#                colour_mage_tmp = cv2.merge((res_r1.get(),res_g1.get(),res_b1.get()))
#                numpy_imagegrey = cv2.cvtColor(colour_mage_tmp, cv2.COLOR_BGR2GRAY)
