...
############################################################################################################
#                                                                                                          #
#                                videos treatment software for ZWO cameras                                 #
#                                                                                                          #
#                                                                                                          #
...
if my_os == "win32" :
    ...
    titre = "JetsonVideos " +  JetsonVideos_version + " Windows RC - CUDA / OPENCV / CUPY / VPI - Copyright Alain PAILLOU 2018-2023"

if my_os == "linux" :
    Dev_system = "Jetson Linux"
    print("Linux system")
    titre = "JetsonVideos " +  JetsonVideos_version + " Linux RC - CUDA / OPENCV / CUPY / VPI - Copyright Alain PAILLOU 2018-2023" 
...
Button5 = Button (cadre,text = "LOAD Vid", command = load_video,padx=10,pady=0)
