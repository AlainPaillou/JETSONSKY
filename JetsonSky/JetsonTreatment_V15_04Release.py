...
def refresh() :
    global camera,traitement, img_cam,cadre_image,rawCapture,image_affichee,image_brut,flag_image_disponible,flag_quitter,\
           ...
           calque_direction_satellites,correspondance,vitesse,sat_id,sat_old_id,compteur_sat,old_sat,sat_speed
...
#                HSV = cv2.merge([h,s,v])
                ...
                image_saturee = cv2.GaussianBlur(image_saturee,(11,11),cv2.BORDER_DEFAULT,)                              
