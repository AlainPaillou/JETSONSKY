...
if my_os == "win32" :
    ...
    titre = "Jetson treatment " +  treatment_version + " Windows release - CUDA / OPENCV - Copyright Alain PAILLOU 2018-2022"

if my_os == "linux" :
    Dev_system = "Jetson Linux"
    print("Linux system")
    titre = "Jetson treatment " +  treatment_version + " Linux release - CUDA / OPENCV - Copyright Alain PAILLOU 2018-2022" 
...
def refresh() :
    global camera,traitement, img_cam,cadre_image,rawCapture,image_affichee,image_brute,flag_image_disponible,flag_quitter,\
           ...
           val_gain, echelle2,val_exposition,echelle1,imggrey1,imggrey2,flag_FDIF,FDIF,flag_TRKSAT,correspondance,labelInfo2,nb_cap_video,flag_cap_video,\
           calque_stars,calque_satellites,calque_TIP,flag_nouvelle_resolution,nb_sat,sat_x,sat_y,sat_old_x,sat_old_y,calque_direction_satellites,video,\
           res_bb1,res_gg1,res_rr1,correspondance,vitesse,sat_id,sat_old_id,compteur_sat,old_sat,sat_speed
        ...
        if flag_noir_blanc == 0 and flag_colour_camera == True:
            ...
            if flag_contrast_CLAHE ==1 :
                ...
                if flag_type_clahe == 2 :
                    ...
                    image_brut_grey_blur = gaussianblur_mono(image_brut_CV_grey,7)
