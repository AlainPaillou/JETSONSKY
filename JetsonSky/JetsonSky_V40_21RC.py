...
def satellites_tracking ():
    ...
    if flag_noir_blanc == 0 and flag_colour_camera == True :
        ...
        try :
            ...
            params_sat.minDistBetweenBlobs = 3
...
echelle70 = Scale (cadre, from_ = 0, to = 20, command= choix_val_SAT, orient=VERTICAL, length = 240, width = 7, resolution = 0.01, label="",showvalue=1,tickinterval=None,sliderlength=10)
