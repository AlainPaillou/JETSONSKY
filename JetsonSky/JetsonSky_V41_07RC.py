                        ...
                        try :
                            ...
                            if flag_filtrage_ON == False and flag_filtre_work == False :
                                ...
                                if flag_noir_blanc == 0 and flag_colour_camera == True :
                                    ...
                                    image_brute = image_brute_cam
                                    Dim = 1
                                if flag_STAB == True and flag_filtrage_ON == True :
...
def application_filtrage(res_b1,res_g1,res_r1) :
    global compteur_FS,Im1OK,Im2OK,Im3OK,compteur_images,numero_image,b1_sm, b2_sm, b3_sm, b4_sm, b5_sm, g1_sm, g2_sm, g3_sm, g4_sm, g5_sm, r1_sm, r2_sm, r3_sm, r4_sm, r5_sm,\
           ...
           val_heq2,val_SGR,val_NGB,val_AGR,flag_filtre_work,flag_AmpSoft,val_ampl,grad_vignet,compteur_FSDN,compteur_RV,flag_SAT,val_SAT,flag_NB_estime,TTQueue,curTT,\
...
CBSTAB.place(anchor="w",x=1450+delta_s, y=535)
...
CBRV.place(anchor="w",x=1500+delta_s, y=535)
...
echelle270.place(anchor="w", x=1540+delta_s,y=535)
