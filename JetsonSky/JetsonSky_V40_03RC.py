...
def refresh() :
    global video,flag_cap_video,camera,traitement,cadre_image,image_brute_base,flag_image_disponible,flag_quitter,timeoutexp,flag_new_image,\
           ...
           val_gain, echelle2,val_exposition,echelle1,imggrey1,imggrey2,flag_FDIF,FDIF,flag_TRKSAT,labelInfo2,Date_hour_image,image_camera,\
           ...
           start_time_video,stop_time_video,time_exec_test,total_time,font,image_camera_old,image_camera
...
#            video = cv2.VideoCapture(Video_Test, cv2.CAP_FFMPEG)
            video = cv2.VideoCapture(Video_Test, cv2.CAP_GSTREAMER)
