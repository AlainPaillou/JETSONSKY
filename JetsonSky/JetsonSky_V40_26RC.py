...
#                        alignMTB.process(img_list, img_list)
                ...
                if flag_stop_acquisition == False and flag_filtre_work == False :
                    ...
                    if res_cam_x > 1350 and flag_full_res == 0 :
                    ...
                    if (res_cam_x > 1350 or res_cam_y > 1012) and flag_full_res == 1 :
                        rs = (res_cam_y - 1012) // 2 - 1
                        re = (res_cam_y + 1012) // 2 + 1
                        cs = (res_cam_x - 1350) // 2 - 1
                        ce = (res_cam_x + 1350) // 2 + 1
                        if rs < 0 :
                            rs = 0
                            re = res_cam_y
                        if cs < 0 :
...
labelParam200.place(anchor="w", x=1840,y=90)
...
CBRRB.place(anchor="w",x=1735, y=50)
...
echelle130.place(anchor="w", x=1720,y=503)
...
cadre_image = Canvas (cadre, width = 1350, height = 1012, bg = "dark grey")
cadre_image.place(anchor="w", x=70,y=1012/2+5)
