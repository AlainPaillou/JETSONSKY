...
#                        new_size = (cam_displ_x,cam_displ_y)
#                        gpu_image = cv2.cuda_GpuMat()
#                        gpu_image.upload(image_traitee)
#                        gpu_resize = cv2.cuda.resize(gpu_image,new_size,interpolation = cv2.INTER_NEAREST)
#                        image_traitee_resize = gpu_resize.download()
...
def application_filtrage(res_b1,res_g1,res_r1) :
    global compteur_FS,Im1OK,Im2OK,Im3OK,compteur_images,numero_image,b1_sm, b2_sm, b3_sm, b4_sm, b5_sm, g1_sm, g2_sm, g3_sm, g4_sm, g5_sm, r1_sm, r2_sm, r3_sm, r4_sm, r5_sm,\
           ...
           flag_cap_pic,flag_traitement,val_contrast_PYTORCH,val_contrast_CLAHE,flag_histogram_phitheta,image_traitee,flag_front,Date_hour_image,image_brute,\
