...
if my_os == "win32" :
    ...
    titre = "JetsonSky " +  JetsonSky_version + " Windows RC - CUDA / OPENCV / CUPY / VPI - Copyright Alain PAILLOU 2018-2023"

if my_os == "linux" :
    Dev_system = "Jetson Linux"
    print("Linux system")
    titre = "JetsonSky " +  JetsonSky_version + " Linux RC - CUDA / OPENCV / CUPY / VPI - Copyright Alain PAILLOU 2018-2023" 
