...
if my_os == "win32" :
    ...
    titre = "Treatment " +  treatment_version + " Windows release - CUDA / OPENCV / CUPY / VPI - Copyright Alain PAILLOU 2018-2022"

if my_os == "linux" :
    Dev_system = "Jetson Linux"
    print("Linux system")
    titre = "Treatment " +  treatment_version + " Linux release - CUDA / OPENCV / CUPY / VPI - Copyright Alain PAILLOU 2018-2022" 
...
def refresh() :
    global val_nb_capt_video,flag_cap_video,image_brute,camera,video,traitement, img_cam,cadre_image,rawCapture,image_affichee,image_brut_CV,flag_image_disponible,\
          ...
          correspondance,vitesse,sat_id,sat_old_id,compteur_sat,old_sat,sat_speed,res_bb1,res_gg1,res_rr1
...
def BG_Subtract() :
    global choix_BGSUB,flag_BG_OK,flag_sub_BG
    if choix_BGSUB.get() == 0 :
        flag_sub_BG = False
    else :
        if flag_BG_OK == True :
            flag_sub_BG = True
...
def capture_BG() :
    global image_BG,flag_BG_OK,res_bb1,res_gg1,res_rr1
    image_BG = cv2.merge((res_bb1,res_gg1,res_rr1))
    flag_BG_OK = True
...
# Bacground substract
CBTBGSUB = Checkbutton(cadre,text="BG Sub", variable=choix_BGSUB,command=BG_Subtract,onvalue = 1, offvalue = 0)
CBTBGSUB.place(anchor="w",x=0, y=820)

Button17 = Button (cadre,text = "CAP BG", command = capture_BG,padx=10,pady=0)
Button17.place(anchor="w", x=0,y=850)
...
echelle70.place(anchor="c", x=15,y=465)
