                ...
                if flag_hold_picture == 0 :
                    ...
                    try :
                        ...
                        if flag_nouvelle_resolution == True :
                            ...
                            flag_nouvelle_resolution = False
                        if flag_sub_dark == True and dispo_dark == 'Dark OK' :
                        ...
                        nb_erreur += 1
                        print("Image acquisition error : ",nb_erreur)
                        time.sleep(0.01)
                else :
                    time.sleep(0.01)
            flag_acquisition_en_cours = False
...
def application_filtrage() :
    ...
    if flag_filtrage_ON == True :            
        ...
        if flag_noir_blanc == 0 and flag_colour_camera == True:
            ...
            if flag_DEMO == 1 :
                image_traitee[0:height,0:width//2] = imag_brute[0:height,0:width//2]               
    else :
        if flag_noir_blanc == 0 and flag_colour_camera == True:        
...
def pic_capture() :
    ...
    if nb_cap_pic <= val_nb_captures :
        ...
        labelInfo1.config(text = " Captures finsihed")
...
def video_capture() :
    ...
    if nb_cap_video == 1 :
        ...
        labelInfo1.config(text = "                                                                                                        ") 
        labelInfo1.config(text = " Video recording running")
    if flag_pause_video == False :
        if time.time() - timer1 >= val_deltat :       
            if nb_cap_video <= val_nb_capt_video :
                ...
                video.release()
                flag_cap_video = False
                labelInfo1.config(text = " Video recording over     ")
            timer1 = time.time()
    else :
