...
def camera_acquisition() :
    global type_debayer,camera,nb_erreur,image_brute,flag_autorise_acquisition,key_pressed,flag_stop_acquisition,\
            ...
            timeoutexp,flag_filtrage_ON,flag_filtre_work,flag_IsColor,labelInfo10,\
...
def start_video_capture() :
    global nb_cap_video,flag_cap_video,start_video,val_nb_capt_video,timer1,frame_number
...
def init_camera() :
    ...
    if flag_ASI_OK == True :
        ...
        if flag_camera_ok == True :
            ...
            if cameras_found[0] == "ZWO ASI290MC" or cameras_found[0] == "ZWO ASI290MM" or cameras_found[0] == "ZWO ASI290MC-Cool" or cameras_found[0] == "ZWO ASI462MC" or cameras_found[0] == "ZWO ASI385MC" :
                res_cam_x = 1936
                res_cam_y = 1096
                cam_displ_x = int(1350*fact_s)
                cam_displ_y = int(760*fact_s)
