...
class acquisition(Thread) :
    ...
    def run(self) :
        global flag_16b,cupy_context,flag_autorise_acquisition,image_brute_cam,timeoutexp,image_captured,New_camera_image,flag_acquisition_thread_OK,nb_erreur
            ...
            while flag_acquisition_thread_OK == True :
                if flag_autorise_acquisition == True :
                    try :
                        ...
                        image_brute_cam = image_camera_tmp.copy()                      
                        image_captured = True
                    except Exception as error :
                        image_captured = False
                        New_camera_image = False
...
def camera_acquisition() :
    global camera,nb_erreur,flag_autorise_acquisition,key_pressed,flag_stop_acquisition,GPU_BAYER,\
           ...
           timeoutexp,flag_filtrage_ON,flag_IsColor,labelInfo10,image_captured,image_brute_cam,\
