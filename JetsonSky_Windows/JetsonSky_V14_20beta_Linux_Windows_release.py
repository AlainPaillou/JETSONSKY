...
if my_os == "win32" :
    ...
    titre = "JetsonSky " +  JetsonSky_version + " Windows release - CUDA / OPENCV - Copyright Alain PAILLOU 2018-2022"

if my_os == "linux" :
    Dev_system = "Jetson Linux"
    print("Linux system")
    titre = "JetsonSky " +  JetsonSky_version + " Linux release - CUDA / OPENCV - Copyright Alain PAILLOU 2018-2022" 
...
def application_filtrage() :
    global image_traitee1,image_traitee2,image_traitee3,image_traitee4,image_traitee5,compteur_FS,Im1OK,Im2OK,Im3OK,\
           ...
           flag_dyn_AADP,Corr_GS,calque_TIP,azimut,hauteur,flag_type_clahe,val_ghost_reducer
    ...
    if flag_filtrage_ON == True :
        ...
        if flag_noir_blanc == 1 or flag_colour_camera == False :
            ...
            if flag_2DConv == 1 or ((flag_histogram_stretch == 1 or flag_histogram_equalize2 == 1 or flag_histogram_phitheta == 1)) or\
               flag_denoise_Paillou == 1 or flag_denoise_soft == 1 or flag_denoise_KNN == 1 or flag_sharpen_soft1 == 1 or flag_unsharp_mask == 1 :
        ...
        if flag_noir_blanc == 0 and flag_colour_camera == True:
            ...
            if flag_2DConv == 1 or ((flag_histogram_stretch == 1 or flag_histogram_equalize2 == 1 or flag_histogram_phitheta == 1)) or\
               ...
               val_reds != 100 or val_greens != 100 or val_blues != 100 or flag_sharpen_soft1 == 1 or flag_unsharp_mask == 1 :
...
fenetre_principale.after(50, refresh)
